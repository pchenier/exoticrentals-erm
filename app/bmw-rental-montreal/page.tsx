...
export const metadata: Metadata = {
  title: 'BMW Rental Montreal. M Series, X5M, X6M | Exotic Rentals Montreal',
  description:
    'Rent a BMW in Montreal from $399/day. M3 Competition, M5 Competition, X5M, X6M. Concierge delivery anywhere in Montreal. Book on WhatsApp.',
...
const serviceSchema = {
  ...
  description: 'Premium BMW rental service in Montreal with concierge delivery. M3 Competition, M5 Competition, X5M, X6M available.',
  offers: {
    '@type': 'Offer',
    priceCurrency: 'CAD',
    price: '399',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'BMW Rental Montreal',
      item: 'https://www.exoticrentalsmontreal.com/bmw-rental-montreal',
    },
  ],
}
...
async function getFleet(): Promise<CarItem[]> {
  try {
    ...
    return all.filter((car) => car.name.toLowerCase().includes('bmw'))
  } catch {
    return []
  }
}

export default async function BMWRentalMontreal() {
        ...
        <main className="pt-24 pb-20 px-4 max-w-7xl mx-auto">
          ...
          <section className="mb-16 text-center">
            ...
            >
              ...
              legendary M3 Competition and M5 Competition to the commanding X5M and X6M,
          ...
          <section className="mb-20">
            ...
            {fleet.length > 0 ? (
              ...
              <p className="text-center text-gray-400" style={{ fontFamily: 'var(--font-inter)' }}>
                Browse our full BMW fleet — contact us for availability.
              </p>
            )}
          </section>
          ...
          <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                { step: '01', title: 'Choose Your BMW', desc: 'Select from our M3, M5, X5M, or X6M fleet.' },
          ...
          <section className="text-center">
            <h2
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Book Your BMW Rental
            </h2>
            <p
              className="text-gray-400 mb-8 text-lg"
              style={{ fontFamily: 'var(--font-inter)' }}
            >
              Ready to experience Montreal in a world-class BMW? Reach us instantly on WhatsApp.
            </p>
            <a
