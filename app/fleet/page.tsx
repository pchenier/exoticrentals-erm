...
const makes = [...new Set(staticVehicles.filter(v => v.available).map(v => v.make))].sort();

// Map make names to brand logo filenames
// Mercedes-AMG and Mercedes-Maybach both use mercedes.svg
...
function FleetContent() {
  ...
  const [allVehicles, setAllVehicles] = useState(staticVehicles);
  ...
  // Sort by make alphabetically, then displayOrder (drag-and-drop within same make)
  filtered.sort((a, b) => {
