  ...
  return (
    <section id="fleet" className="py-32 bg-[#0a0a0a] relative">
      ...
      <div className="sr-only" aria-hidden="true">
        ...
        <Link href="/cars/toyota-supra">Toyota Supra Rental Montreal</Link>
        <Link href="/fleet/lamborghini-huracan-tecnica">Lamborghini Huracan Tecnica Rental Montreal</Link>
        <Link href="/fleet/lamborghini-huracan-evo">Lamborghini Huracan EVO Rental Montreal</Link>
        <Link href="/fleet/lamborghini-huracan-evo-spyder">Lamborghini Huracan EVO Spyder Rental Montreal</Link>
        <Link href="/fleet/mercedes-glc63s-amg">Mercedes GLC63s AMG Rental Montreal</Link>
        <Link href="/fleet/mercedes-g63-amg">Mercedes G63 AMG Rental Montreal</Link>
        <Link href="/fleet/bmw-m3-competition">BMW M3 Competition Rental Montreal</Link>
        <Link href="/fleet/bmw-m4-competition">BMW M4 Competition Rental Montreal</Link>
        <Link href="/fleet/porsche-macan-gts">Porsche Macan GTS Rental Montreal</Link>
        <Link href="/fleet/porsche-panamera-gts">Porsche Panamera GTS Rental Montreal</Link>
        <Link href="/fleet/bentley-bentayga">Bentley Bentayga Rental Montreal</Link>
        <Link href="/fleet/cadillac-escalade">Cadillac Escalade Rental Montreal</Link>
