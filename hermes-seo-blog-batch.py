...
NEW_TOPICS = [
    ...
    {"kw": "Lamborghini Huracan EVO Spyder rental Montreal", "title": "Lamborghini Huracan EVO Spyder Rental Montreal: Drop-Top Thrills", "model": None, "angle": "review"},
    {"kw": "Ferrari Roma rental Montreal", "title": "Ferrari Roma Rental Montreal: Elegant GT Power for City and Coast", "model": None, "angle": "review"},
    {"kw": "Ferrari F8 Tributo rental Montreal", "title": "Ferrari F8 Tributo Rental Montreal: The V8 Mid-Engine Icon", "model": None, "angle": "review"},
    {"kw": "McLaren 720S rental Montreal", "title": "McLaren 720S Rental Montreal: Aero Performance on Montreal Streets", "model": None, "angle": "review"},
    {"kw": "Bentley Continental GT rental Montreal", "title": "Bentley Continental GT Rental Montreal: Grand Touring at Its Finest", "model": None, "angle": "review"},
    {"kw": "Aston Martin DB11 rental Montreal", "title": "Aston Martin DB11 Rental Montreal: British Grand Touring Elegance", "model": None, "angle": "review"},
    {"kw": "Audi R8 V10 Spyder rental Montreal", "title": "Audi R8 V10 Spyder Rental Montreal: Open-Air V10 Symphony", "model": None, "angle": "review"},
    {"kw": "Porsche 911 Turbo S rental Montreal", "title": "Porsche 911 Turbo S Rental Montreal: All-Wheel Drive Supercar Standard", "model": None, "angle": "review"},
    {"kw": "Mercedes AMG GT rental Montreal", "title": "Mercedes AMG GT Rental Montreal: Front-Mid Engine Grand Tourer", "model": None, "angle": "review"},
    {"kw": "BMW M3 Competition rental Montreal", "title": "BMW M3 Competition Rental Montreal: The Everyday Supercar Sedan", "model": "bmw-m3", "angle": "review"},
    {"kw": "Audi RS6 Avant rental Montreal", "title": "Audi RS6 Avant Rental Montreal: The Super Wagon Family Hauler", "model": "audi-rs6", "angle": "review"},
    {"kw": "Rolls-Royce rental Montreal", "title": "Rolls-Royce Rental Montreal: The Ultimate Statement of Luxury", "model": None, "angle": "review"},
    {"kw": "Brabus Mercedes G-Wagon rental Montreal", "title": "Brabus Mercedes G-Wagon Rental Montreal: The Tuner SUV Legend", "model": None, "angle": "review"},
    {"kw": "exotic car rental Westmount Montreal", "title": "Exotic Car Rental Westmount: Luxury Supercar Delivery in West Montreal", "model": None, "angle": "location"},
    {"kw": "exotic car rental Mount Royal Montreal", "title": "Exotic Car Rental Mount Royal: Supercar Delivery on the Mountain", "model": None, "angle": "location"},
    {"kw": "exotic car rental Vieux-Montreal Old Port", "title": "Exotic Car Rental Vieux-Montreal: Supercars in the Old Port District", "model": None, "angle": "location"},
    {"kw": "exotic car rental Laval Quebec", "title": "Exotic Car Rental Laval: Supercar Delivery on the North Shore", "model": None, "angle": "location"},
    {"kw": "exotic car rental Longueuil Quebec", "title": "Exotic Car Rental Longueuil: South Shore Supercar Delivery", "model": None, "angle": "location"},
    {"kw": "exotic car rental Brossard Quebec", "title": "Exotic Car Rental Brossard: Supercar Delivery in the South Shore", "model": None, "angle": "location"},
    {"kw": "exotic car rental Mirabel Quebec", "title": "Exotic Car Rental Mirabel: Luxury Car Delivery in the Laurentian Suburbs", "model": None, "angle": "location"},
    {"kw": "exotic car rental La Prairie Quebec", "title": "Exotic Car Rental La Prairie: South Shore Luxury Car Delivery", "model": None, "angle": "location"},
    {"kw": "exotic car rental Verdun Montreal", "title": "Exotic Car Rental Verdun: Supercar Delivery on the Lachine Canal", "model": None, "angle": "location"},
    {"kw": "exotic car rental Saint-Bruno-de-Montarville", "title": "Exotic Car Rental Saint-Bruno: South Shore Supercar Delivery", "model": None, "angle": "location"},
    {"kw": "exotic car rental Montreal wedding photoshoot", "title": "Exotic Car Wedding Photoshoot Montreal: Supercar Backdrops", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal birthday surprise", "title": "Birthday Surprise Exotic Car Rental Montreal: Gift a Supercar Experience", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal anniversary", "title": "Anniversary Exotic Car Rental Montreal: Recreate the Honeymoon Feeling", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal corporate event", "title": "Corporate Event Exotic Car Rental Montreal: Impress Clients and Teams", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal photoshoot", "title": "Exotic Car Photoshoot Montreal: Rent a Supercar for Your Shoot", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal New Year's Eve", "title": "New Year\'s Eve Exotic Car Rental Montreal: Ring in the Year in a Supercar", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal St-Jean Baptiste", "title": "St-Jean Baptiste Exotic Car Rental Montreal: Celebrate Quebec in Style", "model": None, "angle": "occasion"},
    {"kw": "luxury car rental Montreal business meeting", "title": "Luxury Car Rental Montreal for Business: Arrive Prepared and Impressed", "model": None, "angle": "occasion"},
    {"kw": "exotic car rental Montreal deposit refund", "title": "Exotic Car Rental Montreal Deposit Refund: How and When You Get It Back", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal drivers license", "title": "Exotic Car Rental Montreal Driver\'s License Requirements Explained", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal mileage limit", "title": "Exotic Car Rental Montreal Mileage Policy: What You Need to Know", "model": None, "angle": "guide"},
    {"kw": "how much is exotic car rental deposit Montreal", "title": "How Much Is the Deposit for Exotic Car Rental Montreal", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal step by step guide", "title": "How to Rent an Exotic Car in Montreal: Step-by-Step Guide", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal one way trip", "title": "One-Way Exotic Car Rental Montreal: Drop-Off Options", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal same day booking", "title": "Same-Day Exotic Car Rental Montreal: Last-Minute Supercar Bookings", "model": None, "angle": "guide"},
    {"kw": "exotic car rental Montreal nightlife", "title": "Exotic Car Rental for Montreal Nightlife: Stand Out in the Club District", "model": None, "angle": "experience"},
    {"kw": "location Lamborghini Urus Montreal", "title": "Location Lamborghini Urus Montreal: SUV Luxe et Performance", "model": "lamborghini-urus", "angle": "french"},
    {"kw": "location Ferrari F8 Tributo Montreal", "title": "Location Ferrari F8 Tributo Montreal: Italienne Sportive Disponible", "model": None, "angle": "french"},
    {"kw": "location McLaren 720S Montreal", "title": "Location McLaren 720S Montreal: Vitesse et Agilite", "model": None, "angle": "french"},
    {"kw": "location Bentley Continental Montreal", "title": "Location Bentley Continental Montreal: Elegance Britannique", "model": None, "angle": "french"},
    {"kw": "location voiture exotique Vieux-Montreal", "title": "Location Voiture Exotique Vieux-Montreal: Supercar dans le Vieux-Port", "model": None, "angle": "french"},
    {"kw": "location voiture exotique Westmount", "title": "Location Voiture Exotique Westmount: Livraison Cote Ouest", "model": None, "angle": "french"},
    {"kw": "caution location voiture exotique Montreal", "title": "Caution Location Voiture Exotique Montreal: Combien et Comment", "model": None, "angle": "french"},
    {"kw": "location supercar Montreal anniversaire", "title": "Location Supercar Montreal Anniversaire: Surprisez en Lamborghini", "model": None, "angle": "french"},
